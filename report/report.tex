    ...
    \mychapter{3}{Question 3}
        ...
        \section{Effet de l'augmentation du flux des solides sur le modèle}
            ...
            \begin{figure}[ht]
                ...
                \begin{subfigure}[t]{0.325\textwidth}
                    \centering
                    \includesvg[width=0.95\textwidth]{"image/CH4_mode2_us"}
                    \caption{\ce{CH4}}
                ...
                \begin{subfigure}[t]{0.325\textwidth}
                    \centering
                    \includesvg[width=0.95\textwidth]{"image/H2_mode2_us"}
                    \caption{\ce{H2}}
                ...
                \begin{subfigure}[t]{0.325\textwidth}
                    \centering
                    \includesvg[width=0.95\textwidth]{"image/CO_mode2_us"}
                    \caption{\ce{CO}}
                ...
                \begin{subfigure}[t]{0.325\textwidth}
                    \centering
                    \includesvg[width=0.95\textwidth]{"image/CO2_mode2_us"}
                    \caption{\ce{CO2}}
